...
" my desk. light yellow
let s:bwc.dalespale = ['fade3e', 221]

" A beautiful tan from Tomorrow Night. "lighter yellow
let s:bwc.dirtyblonde = ['f4cf86', 222]

" Delicious, chewy red from Made of Code for the poppiest highlights.
let s:bwc.taffy = ['ff2c4b', 167]
"let s:bwc.taffy = ['ff2c4b', 1]

" Another chewy accent, but use sparingly! "verdino
let s:bwc.saltwatertaffy = ['8cffba', 121]

" The star of the show comes straight from Made of Code. " light blue
let s:bwc.tardis = ['0a9dff', 33]

" This one's from Mustang, not Florida!
let s:bwc.orange = ['ffa724', 214]

" A limier green from Getafe.
let s:bwc.lime = ['aeee00', 118]

" Rose's dress in The Idiot's Lantern. "violetto chiaro
let s:bwc.dress = ['ff9eb8', 212]

" Another play on the brown from Clouds Midnight.  I love that color. "violetto
let s:bwc.toffee = ['b88853', 99]

" Also based on that Clouds Midnight brown.
let s:bwc.coffee    = ['c7915b', 173]   "marrone chiaro
let s:bwc.darkroast = ['88633f', 95]    "marrone scuro
...
call s:HL('Identifier', 'toffee', '', 'none')
call s:HL('Function',   'taffy', '', 'none')
